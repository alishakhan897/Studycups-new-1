                ...
                {!isSubmitted ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="hidden md:block border rounded-2xl p-6 bg-slate-50">
                            <h3 className="text-lg font-bold text-slate-800">How StudyCups helps you in Admission</h3>
                            <div className="mt-4 grid grid-cols-2 gap-4">
                                {[
                                    { title: 'Brochure Details', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M4 3a2 2 0 00-2 2v11a2 2 0 002 2h9a2 2 0 002-2V5a2 2 0 00-2-2H4zm2 3h7v2H6V6zm0 4h7v2H6v-2z"/></svg>
                                    ) },
                                    { title: 'Check Detailed Fees', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M11 17a1 1 0 001 1h3a1 1 0 001-1v-2H11v2z"/><path fillRule="evenodd" d="M11 5a1 1 0 011-1h3a1 1 0 011 1v8H11V5zM3 7a1 1 0 011-1h3a1 1 0 011 1v6H3V7z" clipRule="evenodd"/></svg>
                                    ) },
                                    { title: 'Shortlist & Apply', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-7h2v5H9v-5zm0-4h2v2H9V7z"/></svg>
                                    ) },
                                    { title: '24/7 Counselling', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M18 10a8 8 0 11-16 0 8 8 0 0116 0z"/><path d="M9 9h2v4H9z"/></svg>
                                    ) },
                                    { title: 'Scholarships', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M4 3h12v2H4V3zm0 4h12v10l-6-3-6 3V7z"/></svg>
                                    ) },
                                    { title: 'Application Deadlines', icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-700" viewBox="0 0 20 20" fill="currentColor"><path d="M6 2a1 1 0 011 1v1h6V3a1 1 0 112 0v1h1a2 2 0 012 2v2H3V6a2 2 0 012-2h1V3a1 1 0 011-1z"/><path d="M3 9h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/></svg>
                                    ) }
                                ].map(item => (
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-3 p-4 bg-white rounded-lg border">
                                    <p className="text-sm text-slate-700">StudyCups is a one-stop solution to all your education related queries.</p>
                        ...
                        <div>
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-orange-600">Register Now To Apply</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="course" name="course" required value={formData.course} onChange={handleChange} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-slate-300 focus:outline-none focus:ring-[--primary-medium] focus:border-[--primary-medium] sm:text-sm rounded-md">
                                ...
                                <p className="text-xs text-slate-500 flex items-start gap-2"><span className="inline-block mt-0.5 h-3 w-3 rounded-sm bg-orange-500"></span> By submitting this form, you accept and agree to our Terms of Use.</p>
                                <div className="text-sm font-semibold text-orange-600">Already Registered? Click Here To Login.</div>
                                <button type="submit" className="w-full mt-2 px-6 py-3 font-semibold text-white bg-orange-600 rounded-lg shadow-md hover:bg-orange-700 transition-all duration-300">SUBMIT</button>
                            </form>
                        </div>
                    </div>
                ) : (
                    <div className="text-center py-8">
                        ...
                        <button onClick={handleClose} className="mt-6 w-full px-6 py-3 font-semibold text-white bg-orange-600 rounded-lg shadow-md hover:bg-orange-700 transition-all duration-300">
                            Close
                        </button>
                    </div>
                )}
